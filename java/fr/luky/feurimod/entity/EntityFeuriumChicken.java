package fr.luky.feurimod.entity;

import com.google.common.collect.Sets;
import fr.luky.feurimod.init.ModItems;
import fr.luky.feurimod.utils.handlers.LootTablesHandler;
...
public class EntityFeuriumChicken extends EntityMob {

    private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(ModItems.FEURIUM_INGOT);
    ...
    public EntityFeuriumChicken(World worldIn) {
        super(worldIn);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(0.23500986D);
    }
    ...
    protected ResourceLocation getLootTable() {
        return LootTablesHandler.FEURIUM_CHICKEN;
    }

package fr.luky.feurimod.world.generation.generators;
...
public class WorldGenFeuriumTree extends WorldGenAbstractTree {

    public static final IBlockState LOG = ModBlocks.FEURIUM_LOG.getDefaultState();
    public static final IBlockState LEAF = ModBlocks.FEURIUM_LEAVES.getDefaultState();

    private final int minHeight;

    public WorldGenFeuriumTree(){
        super(false);
        this.minHeight = 12;
    }
                        ...
                        for (int zPos = z - b2; zPos <= z + b2; zPos++){
                            ...
                            if (Math.abs(b3) != b2 || Math.abs(b4) != b2 || rand.nextInt(2) != 0 && b1 != 0){
                                ...
                                if (treeState.getBlock().isAir(treeState, worldIn, treePos) || treeState.getBlock().isAir(treeState, worldIn, treePos)){
                                    ...
                                    this.setBlockAndNotifyAdequately(worldIn, treePos.add(0, -25 * height, 0), LEAF);
    ...
    protected boolean canGrowInto(Block blockType) {
        ...
        return material == Material.AIR || material == Material.LEAVES || material == Material.GROUND || blockType == ModBlocks.FEURIUM_GRASS || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
    }
}
